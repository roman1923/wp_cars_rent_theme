...
?>
		...
		<h1 class="display-4 text-uppercase text-center mb-5"><?php echo esc_html($settings['geniuscourses_title_one']); ?> <span class="text-primary"><?php echo esc_html($settings['geniuscourses_title_two']); ?></span></h1>
