...
<div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-1 text-primary text-center"><?php echo $settings['geniuscourses_title_one']; ?></h1>
            <h1 class="display-4 text-uppercase text-center mb-5"><?php echo $settings['geniuscourses_title_two']; ?></h1>
            <div class="row">
