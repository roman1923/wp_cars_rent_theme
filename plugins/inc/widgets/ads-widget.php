            ...
            <div class="row mx-0">
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-secondary d-flex align-items-center justify-content-between" style="height: 350px;">
                        ...
                        <div class="text-right">
                            <?php if($settings['geniuscourses_title_left']){ ?><h3 class="text-uppercase text-light mb-3"><?php echo esc_html($settings['geniuscourses_title_left']); ?></h3><?php } ?>
                ...
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-dark d-flex align-items-center justify-content-between" style="height: 350px;">
                        <div class="text-left">
                            <h3 class="text-uppercase text-light mb-3"><?php echo esc_html($settings['geniuscourses_title_left']); ?></h3>
